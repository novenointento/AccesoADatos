...
public class FiltroArchivos {
    ...
    public static class FiltroAntesDeUnaFecha implements FileFilter {
        
        private Date fecha;
        
        public FiltroAntesDeUnaFecha(Date fecha) {
            this.fecha = fecha;
        }
        ...
        public boolean accept(File file) {
            Date fechaUltimaModificacion = new Date(file.lastModified());
            return (fechaUltimaModificacion.before(fecha));
        }
    }
    
    public static class FiltroFechaExacta implements FileFilter {
        
        private Date fecha;
        
        public FiltroFechaExacta(Date fecha) {
            this.fecha = fecha;
        }
        ...
        public boolean accept(File file) {
            Date fechaUltimaModificacion = new Date(file.lastModified());
            return (fechaUltimaModificacion.equals(fecha));
        }
    }
}
